...
- The shared cart is then emptied to prepare it for the next customer.24 participants.pop("Student")
 25 print("Recent added student was removed from the system", participants)
"""
