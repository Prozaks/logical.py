...
print(Chinedu)
Tobi = ("Iphone",)            # Proper tuple with one item
new_Tobi = list(Tobi)         # Convert to list to allow modification
new_Tobi.remove("Iphone")     # Remove the item from the list
new_tuple = tuple(new_Tobi)   # Convert back to tuple
